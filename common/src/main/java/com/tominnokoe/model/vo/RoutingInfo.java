...
public final class RoutingInfo {
    ...
    @JsonCreator
    public RoutingInfo(@JsonProperty("primaryBureau") String primaryBureau,
                        @JsonProperty("primaryDivision") String primaryDivision,
                        @JsonProperty("primarySection") String primarySection,
                        @JsonProperty("actionOwner") String actionOwner,
                        @JsonProperty("governanceNotificationTree") List<GovernanceNode> governanceNotificationTree) {
