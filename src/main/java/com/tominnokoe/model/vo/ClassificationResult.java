...
public final class ClassificationResult {
    ...
    public ClassificationResult(boolean isInappropriate, InappropriateReason inappropriateReason,
                                 ClassificationType classificationType, RoutingInfo routing,
                                 ExternalGuidance externalGuidance, double confidenceScore,
                                 List<String> evidenceSources, String suggestedBureauHint) {
